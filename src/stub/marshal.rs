...
mod tests{
    ...
    fn serde_args() {
        ...
        let combined = serde_cbor::to_vec(
            &(object_id,method_handler.clone(),arr.clone(),hostname))
            .unwrap();
        let (object_id_d,method_handler_d,arr_d,hostname_d):
            (RMI_ID,String,Vec<i32>,String)
